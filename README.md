...
This repository shares Mattermost templates contributed by the community of open-source developers and staff members. These templates can be used to create Playbooks, Board cards, change themes, and more!
...
See the [LICENSE file](LICENSE.txt) for license rights and limitations of this repository.
